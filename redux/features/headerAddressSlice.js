...
export const headerAddressSlice = createSlice({
    ...
    initialState : {
        isOpen : false,
        address : [
            {title : "آدرس در تهران", location : "تهران، کشاورز - پارک لاله، ولی عصر، فلسطین، برادران فرزام قبل از مهدوی ۱", city: "تهران"},
            {title : "آدرس در لاهیجان", location : "لاهیجان، انقلاب، امام خمینی شرقی قبل از میدان بصیرت ۱", city : "لاهیجان",}
        ],
        selected : {title : "آدرس در تهران", location : "تهران، کشاورز - پارک لاله، ولی عصر، فلسطین، برادران فرزام قبل از مهدوی ۱", city: "تهران"}
    },
    reducers : {
