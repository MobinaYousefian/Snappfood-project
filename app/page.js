                  ...
                  <div className={"flex rounded-[2rem] bg-surface-main p-12 mt-[10.0625rem]"}>
                      <div className={"grow flex flex-col"}>
                          ...
                          <Link href={"/"} className={"mb-10"}>
                              <button className={"font-iRANSansBold text-lg bg-clip-padding bg-accent-main rounded-[0.375rem] border-accent-main border-solid spBorder transition-socialFooter h-12 inline-flex justify-center items-center box-border min-w-[6.6875rem]"}>
