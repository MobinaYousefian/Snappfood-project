    ...
    return (
        <div className={"flex items-center"}>
            <Link href={"/"} className={"ml-10 max-[599px]:hidden"}>
                <Image src={"/icons/snappfood.svg"} width={68} height={34} alt={"snappfood"} className={"w-[68px] h-[34px]"}/>
            </Link>
            <div onClick={handleOpenModal} className={"cursor-pointer h-10 p-1 inline-flex items-center"}>
                ...
                <div className={"ml-2.5 flex flex-col"}>
                    <p className={"font-iRANSansBold text-sm text-carbon-main"}>{selected.title}</p>
                     <div className={"flex justify-center items-baseline"}>
                        ...
                        <Image src={"/icons/arrow-down-pink.svg"} width={12} height={14} alt={"icon"} className={"w-[12px] h-[14px] mr-[0.6rem]"}/>
                    </div>
                </div>
            </div>
        </div>
