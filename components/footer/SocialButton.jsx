            ...
            <div className={"mr-6 flex flex-wrap w-[calc(100% + 1rem)]"}>
                {socialIcon.map((item, i) => (
                    <div className={"box-border p-[calc(0.5rem)]"} key={i}>
                        <Link href={"/"}>
                            <button
                                className={"inline-flex justify-center items-center w-10 h-10 rounded-full bg-surface-light text-base shadow-sp-medium transition-socialFooter border-socialFooter border-carbon-alphaLight border-solid hover:bg-surface-main"}>
