...
export const SupportModal = () => {
    ...
    return (
        <div onClick={handleClose} className={"flex justify-center items-center fixed inset-0 z-[10000] modal-card-animation"}>
            <div ref={supportRef} className={"fixed right-[16px] bottom-[70px] w-[285px] max-w-[375px] sp-laptop:w-[375px] sp-laptop:h-[85vh] h-[80vh] bg-surface-light shadow-sp-modal rounded-xl max-h-[90vh] overflow-hidden search-modal-card-animation"}>
