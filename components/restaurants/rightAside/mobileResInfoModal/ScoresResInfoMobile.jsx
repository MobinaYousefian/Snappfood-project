...
export const ScoresResInfoMobile = ({resInfo}) => {
    return (
        <div className={"items-center h-[6.75rem] flex flex-col mt-8"}>
            <div className={"items-center flex justify-end flex-col"}>
                <p className={"font-iRANSansBold text-2xl text-carbon-main flex items-baseline justify-center"}>
            ...
            <div className={"pb-4 flex justify-end flex-col items-end my-2"}>
                {
                    starRating.map((item, i) => (
                        <div className={"flex items-center mt-[0.3125rem]"} key={i}>
                            ...
                            <div className={clsx( i === 0 ? "after:bg-[rgb(2,137,10)] after:w-[67%]": i === 1 ? "after:w-[46%] after:bg-[rgb(104,195,66)]" : i === 2 ? "after:w-[33%] after:bg-[rgb(171,232,35)]" : i === 3 ? "after:w-[19%] after:bg-[rgb(254,157,7)]" : i === 4 && "after:w-[7%] after:bg-[rgb(254,57,0)]" ,"after:shadow-sp-small flex rounded bg-[rgb(235,237,240)] mr-4 w-[10rem] h-[0.125rem]")}> </div>
                        </div>
                    ))
                }
            </div>
